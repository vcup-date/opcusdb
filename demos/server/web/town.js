...
// residents on a (optionally pre-rendered) map; you walk in and talk to
...
function makeSpriteChar(row, isHuman, ringCol) {
 ...
 // the offline image tool, slow on this machine, and the video-to-clean-sprite conversion needs a human
